...
![Figure 1. Importance of singular values by total factors (principal components)](../images/fig1.png)
...
![Figure 2. Accuracy of the model when each dimension resulting from the reduced matrix was introduced as input to the model](../images/fig2.png)
...
![Figure 3. Expression levels for the top 10 most important genes by the Information Gain algorithm](../images/fig3.png)
...
![Figure 4. Projection of the Samples in Space of weight distribution derived from the logistic regression model](../images/fig4.png)
...
![Figure 5. Expression levels for the top 20 most important genes according to the weight distribution derived from the logistic regression model](../images/fig5.png)
